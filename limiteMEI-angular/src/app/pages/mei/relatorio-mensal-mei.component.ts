...
@Component({
  ...
  template: `
    ...
    @if (relatorio) {
      <main class="sheet">
        <header><h1>RELATÓRIO MENSAL DAS RECEITAS BRUTAS</h1><div><span><strong>CNPJ:</strong> {{formatarCnpj(relatorio.cnpj)}}</span><span><strong>Empreendedor individual:</strong> {{relatorio.razaoSocial}}</span><span><strong>Período de apuração:</strong> {{nomeMes(relatorio.mes)}} de {{relatorio.ano}}</span></div></header>
  ...
  `,
  styles: [`
    .screen-actions{display:flex;justify-content:flex-end;gap:.6rem;margin-bottom:1rem}.screen-actions button{padding:.6rem 1rem;border:1px solid #ccd2df;border-radius:6px;background:#fff}.screen-actions .primary{border-color:#5570f1;background:#5570f1;color:#fff}.sheet{width:210mm;min-height:297mm;margin:auto;padding:16mm;background:#fff;color:#111;box-shadow:0 2px 14px #0002}.sheet header h1{text-align:center;font-size:18px}.sheet header div{display:flex;flex-direction:column;gap:5px;margin:20px 0}.draft{text-align:center;padding:8px;border:2px solid #b77900;color:#8a5900;font-weight:700}.sheet section{margin-top:18px;border:1px solid #333}.sheet section h2{margin:0;padding:8px;background:#e9ecef;font-size:12px}.sheet section p{display:flex;justify-content:space-between;margin:0;padding:8px;border-top:1px solid #777;font-size:12px}.sheet section .total{font-weight:700;background:#f5f5f5}.grand-total{display:flex;justify-content:space-between;margin-top:18px;padding:12px;border:2px solid #111;font-weight:700}.sheet footer{margin-top:35px;font-size:11px}.signature{width:280px;margin:55px auto 25px;text-align:center}.signature span{display:block;border-top:1px solid #111}.signature p{margin-top:5px}.loading{text-align:center;padding:4rem}@media print{.screen-actions{display:none}.sheet{width:auto;min-height:auto;margin:0;padding:8mm;box-shadow:none}@page{size:A4;margin:8mm}}
  `],
})
